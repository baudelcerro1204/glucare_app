...
content = '''
La diabetes tipo 2 es una enfermedad crónica que afecta la manera en que el cuerpo metaboliza el azúcar (glucosa), que es una fuente importante de combustible para el cuerpo. A diferencia de la diabetes
tipo, donde el cuerpo no produce insulina, enla diabetes tipo 2 el cuerpo se vuelve resistente ala insulina o no produce suficiente insulina para mantener niveles normales de glucosa en sangre.

Posibles síntomas:
• Aumento dela sed yla mición frecuente.
• Hambre extrema.
• Pérdida de peso no intencional.
• Fatiga.
• Visión borrosa.
• Infecciones frecuentes, especialmente en las encías, la piel yla
vejga.
• Áreas oscuras en laplel, generalmente en las axlas y el cuello
  (acantosis nigricans).
Tratamiento:
Eltratamiento de la diabetes tipo 2 implica varios enfoques para
mantenerlos niveles de glucosa en sangre dentro de un rango
saludable:
...
content = '''
La diabetes gestacional es un tipo de diabetes que se desarrolla durante el embarazo y generalmente desaparece después del parto. Es importante identificar y manejar adecuadamente la diabetes gestacional
...
resistencia a la insulina, haciendo que sea más difícil para el cuerpo usar la insulina de manera efectiva.

Factores de Riesgo
Los factores que aumentan el riesgo de desarrollar diabetes gestacional
incluyen:
• Obesidad: Tener un índice de masa corporal (IMC) de 30 o más.
• Antecedentes familiares: Tener un familiar cercano con diabetes tipo
  2.
• Edad: Ser mayor de 25 años al quedar embarazada.
• Antecedentes personales: Haber tenido diabetes gestacional en un
  embarazo anterior o haber dado a luz a un bebé 
  muy grande (más de 4Kg).
• Condiciones médicas previas: Tener síndrome 
  de ovario poliquístico (SOP) o prediabetes.
Posibles síntomas:
• Aumento de la sed.
• Micción frecuente.
• Fatiga.
...
content = '''
El tratamiento farmacológico para la diabetes depende del tipo de
diabetes y de las necesidades específicas del paciente.
Medicamentos para la Diabetes Tipo 1:
1. Insulina de acción rápida:
  • Ejemplos: Insulina lispro (Humalog), insulina aspart (NovoLog)
    insulina glulisina (Apidra)
  • Inicio de acción: 10-30 minutos.
  • Duración: 3-5 horas.
  • Uso: Administrada antes de las comidas para controlar el
...
3. Insulina de acción intermedia:
  ...
  • Uso: Administrada una o dos veces al día para 
    el control basal
4. Insulina de acción prolongada:
  • Ejemplos: Insulina glargina (Lantus, Toujeo), 
    insulina detemir (Levemir), insulina degludec 
    (Tresiba).
...
content = '''
La hipoglucemia, o bajo nivel de glucosa en sangre, es una condición que puede ocurrir en personas con diabetes, especialmente aquellas que están en tratamiento con insulina o ciertos medicamentos antidiabéticos. Manejar adecuadamente las situaciones de
hipoglucemia es crucial para evitar complicaciones graves. Aquí te proporciono una guía detallada sobre cómo manejar estas situaciones: Reconocer los Síntomas de Hipoglucemia
...
• Somnolencia.
• En casos graves, pérdida del conocimiento o convulsiones. Medir los Niveles de Glucosa en Sangre
...
1. Beber Agua:
• La deshidratación puede empeorar la hiperglucemia, por lo que es
''';
        break;
      default:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Información sobre la diabetes'),
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButton<String>(
                hint: Text('Seleccionar una sección:'),
                items: <String>[
              ...
              Padding(
                ...
                child: Text(
                  '¿Necesitas más ayuda? Recorda contactar a tu medico de cabecera para una atencion profesional.',
